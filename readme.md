...
### CSS ANIMATIONS
* The project uses CSS Animations to accomplish animated effects in specific areas where GSAP or jQuery is not used.
...
### GSAP
* The project uses GSAP to achieve animations for specific areas.
...
- The Resume page contains a landing section, where there are delays on the nav bar to actually show up and the sentence "Welcome to my resume page. Enjoy." is written out, by using a typewriter effect. 
- The Resume page also contains a section of an "About me" text and three linked articles underneath. These articles are located at www.spce.com and are written by Rasmus Hammarberg. 
...
- The page also contains a Google Map JavaScript API. Which gives the user the possibility to see where Rasmus Hammarberg's office is located. 
...
* The site was deployed to GitHub pages. These are the steps that I followed to deploy my site:
- In the GitHub Repository, click on the settings option. 
- In the source section drop-down menu, select the Master Branch.
- When that has been done, save the selection. 
- Scroll down to where it says "Pages settings now has its own dedicated tab! Check it out here!" and click on it. 

The live link can be found here - (https://colinhammarberg.github.io/MS2/)
